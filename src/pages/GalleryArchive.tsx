 ...
 * GalleryArchive.tsx
 * 
 * ARCHIVED PORTFOLIO PAGE
 * This is a comprehensive gallery of all deck projects with filtering capabilities.
 * NOTE: This is different from the "Portfolio Section" on the homepage.
 * Route: /gallery-archive
 * 
 * To avoid confusion:
 * - "Portfolio Section" = Homepage hero section "Built to Endure" 
 * - "Gallery Archive" = This dedicated page with full project catalog
 */
...
const GalleryArchive: React.FC<{ onOpenQuote?: () => void }> = ({ onOpenQuote }) => {
