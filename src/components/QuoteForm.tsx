      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              required
              className={`w-full px-4 py-3 bg-white border rounded-lg text-gray-900 placeholder-gray-500 transition-colors ${getFieldError('name')
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              required
              className={`w-full px-4 py-3 bg-white border rounded-lg text-gray-900 placeholder-gray-500 transition-colors ${getFieldError('email')
                  ? 'border-red-500 focus:border-red-500 focus:ring-1 focus:ring-red-500'
                  : 'border-gray-300 focus:border-primary focus:ring-1 focus:ring-primary'
                }`}
        ...
        <div>
          ...
          <input
            ...
            onChange={handleInputChange}
            className={`w-full px-4 py-3 bg-white border rounded-lg text-gray-900 placeholder-gray-500 transition-colors ${getFieldError('phone')
                ? 'border-red-500 focus:border-red-500 focus:ring-1 focus:ring-red-500'
                : 'border-gray-300 focus:border-primary focus:ring-1 focus:ring-primary'
              }`}
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleInputChange}
            rows={3}
            className={`w-full px-4 py-3 bg-white border rounded-lg text-gray-900 placeholder-gray-500 transition-colors resize-none ${getFieldError('projectDetails')
                ? 'border-red-500 focus:border-red-500 focus:ring-1 focus:ring-red-500'
                : 'border-gray-300 focus:border-primary focus:ring-1 focus:ring-primary'
              }`}
          ...
          {!formData.projectImage ? (
            <div className="relative">
              ...
              <label
                ...
                className={`w-full px-4 py-4 bg-gray-50 border-2 border-dashed rounded-lg text-center cursor-pointer transition-colors flex flex-col items-center space-y-2 hover:bg-gray-100 ${getFieldError('projectImage')
        ...
        <div className="flex items-start space-x-3">
          ...
          <label htmlFor="consent" className="text-sm text-gray-700 leading-relaxed">
            By checking this box and submitting this form, I consent to receive marketing communications from Deck Masters via phone, email, and text message. I understand that I can opt out at any time by replying STOP to text messages or unsubscribing from emails. Message and data rates may apply. I acknowledge that I have read and agree to the{' '}
        ...
        <button
          ...
          className={`w-full bg-accent hover:bg-accent/90 text-primary px-8 py-4 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center group ${isSubmitting
